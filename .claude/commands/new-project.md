Use only when cloning this template to start a new project. If the project already has files or folders beyond `.claude/commands`, `.claude/aigent`, `.gitignore` and `README.md`, warn the user not to run this command.
Process:
